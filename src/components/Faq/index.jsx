    ...
    return (
        <div id="faqsection">
            ...
            <div className='faqscontainer'>
                <button className={ showResults === "1" && displayResult ? "purplebutton buttonfaq" : "buttonfaq"} type="button" id="1" onClick={handleClick}>
                ...
                <button className={ showResults === "2" && displayResult ? "purplebutton buttonfaq" : "buttonfaq"}  type="button" id="2" onClick={handleClick}>
                    <div className="questionfaq">
                ...
                <button className={ showResults === "3" && displayResult ? "purplebutton buttonfaq" : "buttonfaq"}  type="button" id="3" onClick={handleClick}>
                    <div className="questionfaq">
                ...
                <button className={ showResults === "4" && displayResult ? "purplebutton buttonfaq" : "buttonfaq"}  type="button" id="4" onClick={handleClick}>
                    <div className="questionfaq">
                ...
                <button className={ showResults === "5" && displayResult ? "purplebutton buttonfaq" : "buttonfaq"}  type="button" id="5" onClick={handleClick}>
                    <div className="questionfaq">
